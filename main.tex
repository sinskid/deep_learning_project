...
ViT-tiny-patch16-224 & 5,7M & 23 & ImageNet1K & Non-fournie \\
\hline
\end{tabular}
\caption{Caractéristiques des modèles utilisés, ViT est plus léger mais les deux modèles ont même ordre de grandeur de paramètres et de taille.} %ajouter des références
\end{table}
